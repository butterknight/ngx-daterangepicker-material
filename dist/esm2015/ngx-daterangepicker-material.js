import { Component, ElementRef, EventEmitter, Output, Directive, ViewContainerRef, ComponentFactoryResolver, HostListener, forwardRef, ChangeDetectorRef, Input, KeyValueDiffers, NgModule } from '@angular/core';
...
class DaterangepickerDirective {
     ...
     * @param {?} differs
     */
    constructor(viewContainerRef, _changeDetectorRef, _componentFactoryResolver, _el, differs) {
